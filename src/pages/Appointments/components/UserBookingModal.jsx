...
function UserBookingModal({ isOpen, onClose, defaultServiceId = null }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-lg rounded-2xl border border-slate-800 bg-slate-900 p-4 sm:p-6 shadow-2xl">
        <button onClick={onClose} className="absolute right-4 top-4 rounded-lg p-1 text-slate-400 hover:bg-slate-800 hover:text-white">
          <X className="h-5 w-5" />
        </button>
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  className={cn(
                    ...
                    errors.date ? 'border-red-500/50' : 'border-slate-800 focus:border-rose-500 focus:ring-1 focus:ring-rose-500'
                  )}
                  {...register('date')}
                />
